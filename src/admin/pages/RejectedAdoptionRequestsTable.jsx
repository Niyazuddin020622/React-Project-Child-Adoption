...
const RejectedAdoptionRequestsTable = ({ rejectedRequests }) => {
  ...
  const handleDownloadExcel = () => {
    const formattedData = rejectedRequests.map((request, index) => ({
      "S.No": index + 1,
      ...
      "Rejected Date": request.adoptionDate
    ...
    XLSX.utils.book_append_sheet(workbook, worksheet, "RejectedRequests");
    ...
    saveAs(data, "Rejected_Adoption_Requests.xlsx");
  };

  return (
    <>
      <div className="d-flex justify-content-between align-items-center m-4">
        <h3>Rejected Adoption Requests</h3>
