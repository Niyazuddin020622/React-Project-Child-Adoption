      ...
      <div className="card p-4 shadow-lg w-100" style={{ maxWidth: '800px' }}>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="row g-3 mt-3">
            ...
            <div className="col-md-4">
              <button type="button" className="btn btn-primary w-100" onClick={sendEmailOTP}>Send OTP</button>
            </div>
            <div className="col-md-4">
              <input type="text" name="emailOTP" placeholder="Enter OTP" className="form-control" onChange={handleChange} required />
            </div>
            <div className="col-md-4">
              <button type="button" className="btn btn-success w-100" onClick={verifyEmailOTP}>Verify</button>
            </div>
          </div>
          ...
          <div className="row g-3 mt-3">
            ...
            <div className="col-md-4">
              <button type="button" className="btn btn-primary w-100" onClick={sendMobileOTP}>Send OTP</button>
            </div>
            <div className="col-md-4">
              <input type="text" name="mobileOTP" placeholder="Enter OTP" className="form-control" onChange={handleChange} required />
            </div>
            <div className="col-md-4">
              <button type="button" className="btn btn-success w-100" onClick={verifyMobileOTP}>Verify</button>
            </div>
          </div>

          <div className="mt-3">
            <textarea name="reason" placeholder="Why do you want to adopt?" className="form-control" onChange={handleChange} required />
          </div>
